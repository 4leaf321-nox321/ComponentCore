...
test('만료일은 날짜로 고르고, 발급한 토큰이 도구별 등록 형식에 채워진다', async () => {
  ...
  expect(screen.getAllByText(/compcore_pat_SECRET/).length).toBeGreaterThan(0)
